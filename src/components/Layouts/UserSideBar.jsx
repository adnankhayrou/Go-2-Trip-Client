      ...
      <aside
        ...
        <div className=" rounded-2xl h-full px-3 overflow-y-auto bg-white dark:bg-white border-light shadow-2xl">
          ...
          <li className=''>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-gray-500 transition duration-75 dark:text-yellow-600 group-hover:text-gray-900 dark:group-hover:text-white">
