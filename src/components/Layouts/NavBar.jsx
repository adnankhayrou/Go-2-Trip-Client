    ...
    >
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex items-center justify-between sm:ms-3">
          ...
          <span className="count absolute top-4 sm:top-[17px] sm:right-[68px] right-[60px] text-xs bg-red-500 rounded-full w-4 h-4 text-center text-white font-bold">8</span>
