  ...
  return (
    ...
    {!sidebarOpen && (
      ...
      <aside
        ...
        <div className="h-full px-3 pt-8 py-4 overflow-y-auto bg-white dark:bg-white border-light shadow-lg">
          ...
          <div className='ms-1 mt- flex items-center'>
          {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mt-4 w-10 h-10 dark:text-sky-500">
            <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg> */}
          <div className="mt-4 w-10 h-10 me-1">
          ...
          <ul className="ms-3 space-y-2 mt-5 font-medium items-center text-center">
            ...
            <li className='pt-2'>
            <Link to="" className="mb-5 flex items-center p-2 text-black rounded-lg hover:bg-gray-200">
            ...
            <li>
                <Link to="/forgotPassword" className="mb-5 flex items-center p-2 text-black rounded-lg hover:bg-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-gray-500 transition duration-75 dark:text-sky-500 group-hover:text-gray-900 dark:group-hover:text-white">
            ...
            <li>
                <Link onClick={logout} className="mb-5 flex items-center p-2 text-black rounded-lg hover:bg-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-gray-500 transition duration-75 dark:text-sky-500 group-hover:text-gray-900 dark:group-hover:text-white">
