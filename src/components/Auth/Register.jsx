      ...
      <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleSubmit}>
        ...
        <div className="inline-flex items-center">
            <p className="flex mt-3 items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
              <Link className="font-medium text-black transition-colors hover:text-red-700" to="/forgotPassword"> Forgot Password? </Link>
            </p>
        </div>
        ...
        <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
          ...
          <Link className="ms-2 font-medium text-black transition-colors hover:text-red-700" to="/login">
            Sign In
          </Link>
        </p>
      </form> 
