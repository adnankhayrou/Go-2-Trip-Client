...
const [formData, setFormData] = useState({
    ...
    if(Object.keys(validationErrors).length === 0 ){
        axios.post('http://localhost:3000/api/auth/forgotPassword', formData)
        .then(result => {
        console.log(result)
    ...
    <div className="flex items-center justify-center h-screen">
        ...
        {message && (
            ...
            <button
                ...
                onClick={() => setMessage(null)} // This clears the error
            >
        ...
        <div>
            ...
            <Link className="mt-6 mb-2 block w-20 select-none rounded-lg bg-black py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md transition-all hover:shadow-lg  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                to="/">
                Back
            </Link>
            ...
            <button className="mt-6 block w-full select-none rounded-lg bg-black py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md transition-all hover:shadow-lg focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                data-ripple-light="true">
                Send
            </button>
            <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
            This e-mail is valid only 10 minutes
            </p>
            </form>
        </div>
        </div></>
